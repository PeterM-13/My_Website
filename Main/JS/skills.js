const skillInfo = {
    ...
    Swift: " > Programming language used to develop apps for Apple products.",
    Xcode: " > Application to develop apps for the Apple App Store.",
    "Azure Devops": " > A Microsoft product that provides project management and DevOps tools.",
    "Microsoft Office": " > Suite including Word, Excel, PowerPoint, Outlook, OneNote.",
    ...
    "Tensor Flow": " > An open-source platform for machine learning and artificial intelligence.",
    "EasyEDA": " > A tool for electronics design, including schematic capture, circuit simulation and PCB layout.",
    "MATLAB": " > A platform for algorithm development, data analysis, visualisation, and computation.",
    "Visual Studio": " > An integrated development environment (IDE) from Microsoft for developing applications.",
    "Terminal / Linux": " > Proficient with command-line interfaces and Linux-based operating systems.",
    ...
    Jira: " > A tool for tracking issues, managing projects, and supporting agile software development.",
