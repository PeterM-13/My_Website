...
const PROJECTS = { 
    2026: [
        {name:"AI Football", date:"18/3/26", images:["Football 1.png","Football 2.png","Football 3.png","Football 4.png","Football 5.png"], info:"Artificial intelligence learns to play football", keyWords:['software','AI']},
        {name:"UK Exploring Website", date:"11/3/26", images:["Explore 1.jpeg", "Explore 2.jpeg", "Explore 3.jpeg"], info:"Website for adventures, to find new places to visit, <a target='_blank' href='https://peter-metcalfe.co.uk/Explore'>see here</a>", keyWords:['software']},
        ...
        {name:"Pub Tracking Website", date:"20/5/26", images:["Spoons 1.jpeg", "Spoons 2.jpeg", "Spoons 3.jpeg"], info:"Website to track weatherspoon visits and compete with friends, <br><a target='_blank' href='https://peter-metcalfe.co.uk/Spoons'>see here</a>", keyWords:['software', 'AI']},
        {name:"Rocket Car Timing Gate", date:"18/6/26", images:["LightGate 2.jpeg", "LightGate 1.jpeg"], info:"Infrared timing gate built for a local school rocket car competition", keyWords:['software','electrical']},
    ],
    2025: [
        ...
        {name:"AI Song Rater", date:"29/5/25", images:["songRater1.jpeg","songRater2.jpeg"], info:"A custom AI model designed to rate songs based on my preference, <a target='_blank' href='https://github.com/PeterM-13/AI-Song-Rater'>see on GitHub</a>", keyWords:['software','AI']},
    ...
    2022: [
        {name:"Rain Simulator", date:"09/01/22", images:["Rain Sim 1.jpg","Rain Sim 2.jpeg","Rain Sim 3.jpeg","Rain Sim 4.jpeg"], info:"Allows you to experiment with different velocities and angles to find optimal conditions to stay dry, <a target='_blank' href='https://peter-metcalfe.co.uk/rain'>see here</a>", keyWords:['software']},
