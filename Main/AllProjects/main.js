...
const PROJECTS = { 
    2023: [
        ...
        {name:"Smart Walking Stick", date:"31/01/23 - 29/09/23", images:["StepSmart1.PNG","StepSmart2.jpg","StepSmart3.jpeg","StepSmart4.jpg","StepSmart5.jpg","StepSmart6.jpg","StepSmart7.jpg","StepSmart8.jpg","StepSmart9.jpeg"], info:"Led team to vicotry, making a smart walking stick in IMechE automation challenge. Got fall detection, torch, app & more.", keyWords:['software','electrical','mechanical','invention','team','award']},
    ],
    2022: [
        ...
        {name:"Squid Game", date:"17/01/22", images:["Squid Game 1.jpeg","Squid Game 2.jpeg","Squid Game 3.jpeg","Squid Game 4.jpeg","Squid Game 5.jpeg"], info:"6 player game that will randomly shock a player each round, eliminating them...", keyWords:['software','mechanical','electrical','invention']},
        ...
        {name:"'Alien Crush' 2D Game", date:"16/03/22", images:["Alien Crush 2D 1.jpeg","Alien Crush 2D 2.jpeg","Alien Crush 2D 3.jpeg"], info:"My first mobile game, live on the AppStore. Fly through space & try to survive without getting crushed!", keyWords:['software','invention']},
        {name:"Fractal Generator V1", date:"31/03/22", images:["Fractal Generator V1 1.jpeg","Fractal Generator V1 2.jpeg","Fractal Generator V1 3.jpeg"], info:"App that generates the Mandelbrot set next to corresponding Julia set position, allowing you to make cool fractals", keyWords:['software']},
        {name:"Fractal Generator V2", date:"11/04/22", images:["Fractal Generation V2 1.png", "Fractal Generation V2 2.png","Fractal Generation V2 3.PNG","Fractal Generation V2 4.jpeg","Fractal Generation V2 5.jpeg","Fractal Generation V2 6.jpeg"], info:"I used shaders to run the maths on the GPU in this version, made the app fast and detailed", keyWords:['software','award']},
        ...
        {name:"'Alien Crush 3D' Game", date:"01/08/22", images:["Alien Crush 3D 1.jpeg","Alien Crush 3D 2.jpeg","Alien Crush 3D 3.jpeg","Alien Crush 3D 4.jpeg"], info:"This was my first 3D game, live on the AppStore. Fly through space & try to survive until the end!", keyWords:['software','invention']},
        {name:"Pea Gun", date:"31/08/22", images:["Pea Gun 1.jpeg","Pea Gun 2.jpeg","Pea Gun 3.jpeg","Pea Gun 4.jpeg"], info:"Built this gun to shoot peas using compressed air", keyWords:['mechanical','electrical','invention']},
    ...
    2021: [
        ...
        {name:"'Devil's Dungeon' Game", date:"31/05/21", images:["Devils Dungeon 1.jpeg","Devils Dungeon 2.png","Devils Dungeon 3.jpeg","Devils Dungeon 4.jpeg","Devils Dungeon 5.jpeg"], info:"Game Dev competition with McAfee; open world, puzzle solving game, fight enemies and avoid obstacles", keyWords:['software','award']},
        {name:"'Chicken Run' Game", date:"07/09/21", images:["Chicken Run 1.jpeg","Chicken Run 2.png","Chicken Run 3.jpeg","Chicken Run 4.jpeg"], info:"Fun 2 player desktop game where you each control a chicken, it's a race to the finish line", keyWords:['software']},
